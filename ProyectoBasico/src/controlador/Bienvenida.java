...
public class Bienvenida extends HttpServlet {//clase de herencia de HttpServlet
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//response.getWriter().append("Parametros: x: " + param1 + " y: " + param2);//.append(request.getContextPath());
	...
	@Override
	public void init() throws ServletException {//se ejecuta cuando se cede el control al servlet
